...
public class CtaManager {
    ...
    /**
     * To notify CTA framework that App's status about auto boot is changed.
     *
     * @param context App package context.
     * @param packageName App package name.
     * @param status Current status about auto boot after changed.
	...
	/**
     * Query Apps that don't allow auto boot.
     *
     * @param context App package context.
     * @param userId Current user id.
     * @return App's package name and status that don't allow auto boot.
     */
    @ProductApi
